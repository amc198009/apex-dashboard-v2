...
export function Nav() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-60 flex-col border-r border-white/[0.06] bg-[#0c0e14]/80 backdrop-blur-xl">
      <div className="px-6 pt-7 pb-6">
        <div className="flex items-center gap-2.5">
          <span className="grid h-8 w-8 place-items-center rounded-xl bg-apex-red/15 text-apex-red font-bold text-lg ring-1 ring-apex-red/25">A</span>
          <div>
